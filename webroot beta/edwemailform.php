      ...
      <tr>
         ...
         <td width="200" align="left">
           <?php echo htmlentities(trim($_POST["email"]), ENT_COMPAT, "UTF-8"); ?>
			...
			<tr>
         <td width="150" align="left" valign="middle" height="2">
           <i><font face="Arial" size="2">Referral:</font></i>
         </td>
          <td width="200" align="left">
            <?php echo htmlentities(trim($_POST["refer"]), ENT_COMPAT, "UTF-8"); ?>
          </td>
			</tr>
      <tr>
         <td width="150" align="left" valign="middle" height="2">
...
<?
   ...
   //Customer Emails
   //// NOPE mail("aaronf@intellisoftmn.com","Contact Request from Edwards MFG",$body,"From: website@edwardsironworkers.com\r\nContent-Type: text/html; charset=\"us-ascii\"");
   mail("charlesk@netgaintechnology.com","Contact Request from Edwards MFG",$body,"From: website@edwardsironworkers.com\r\nContent-Type: text/html; charset=\"us-ascii\"");
   mail("service@edwardsmfg.us","Contact Request from Edwards MFG",$body,"From: website@edwardsironworkers.com\r\nContent-Type: text/html; charset=\"us-ascii\"");
   // mail("dave@voyageurweb.com","Contact Request from Edwards MFG",$body,"From: website@edwardsironworkers.com\r\nContent-Type: text/html; charset=\"us-ascii\"");
